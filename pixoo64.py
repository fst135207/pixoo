...
from InstallModuls import pixoo
...
def main():
    ...
    while True:
        ...
        pixoo.draw_text(f'{temperature}C', (39, 57), white)
        ...
        pixoo.draw_text(f'{current_time}', (2, 8), white)
        pixoo.draw_text(f'{current_date}', (2, 2), white)
        pixoo.push()  # Anzeigen
